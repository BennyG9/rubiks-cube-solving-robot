...
## Notes
INCLUDED: full script which runs directly on Raspberry Pi, color data JSON file for classification algorithm, solver algorithm development file where all of the pruning data was generated.
